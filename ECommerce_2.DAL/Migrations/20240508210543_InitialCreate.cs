        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Carts_AspNetUsers_User2Id",
                        column: x => x.User2Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_User2Id",
                        column: x => x.User2Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "good product ", "headphone", 3000f },
                    { 2, 3, "good product oppo ", "phone", 40000f },
                    { 3, 2, "good product apple ", "Iphone", 90000f }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Carts_User2Id",
                table: "Carts",
                column: "User2Id",
                unique: true,
                filter: "[User2Id] IS NOT NULL");
